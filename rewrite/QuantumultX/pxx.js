...
var pxx91714468 = JSON.parse(typeof $response != "undefined" && $response.body || "{}");
var headers = {};
...
var receipt = {
  ...
  "purchase_date": "2024-06-28 06:06:06 Etc/GMT",
  "product_id": "pxx917144686",
  "original_purchase_date_pst": "2024-06-28 06:06:06 America/Los_Angeles",
  ...
  "purchase_date_pst": "2024-06-28 06:06:06 America/Los_Angeles",
  "original_purchase_date": "2024-06-28 06:06:06 Etc/GMT"
};
...
for (var uaKey in uaProductMapping) {
  if (UA && UA.includes(uaKey)) {
    ...
    pxx91714468.receipt = { in_app: [receipt] };
    pxx91714468.latest_receipt_info = [receipt];
    pxx91714468.pending_renewal_info = [renewal];
    break;
  }
}
$done({ body: JSON.stringify(pxx91714468) });
